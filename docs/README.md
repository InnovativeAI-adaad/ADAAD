...
> Internal architecture, API contracts, configuration, evidence artifacts, and test coverage for **ADAAD v9.93.0 · Phase 101 (INNOV-16 Emergent Role Specialization (ERS) shipped)**. For user-facing setup see [QUICKSTART.md](../QUICKSTART.md). For the 23 rules see [CONSTITUTION.md](CONSTITUTION.md). For build-agent protocol see [AGENTS.md](../AGENTS.md).
>
