...
| **Released** | `2026-06-04` |
| **Release SHA** | `f9762fb` |
| **Hard-class invariants** | `689` |
| **Innovations shipped** | `111` |
...
| Shipped innovations | **111** — INNOV-01 through INNOV-??? |
